...
module.exports = app => {
  ...
  async function getChannelForOrg(org, channels, networkType = 'fabric-1.0') {
    switch (networkType) {
      ...
      case 'fabric-1.4':
        return await app.getClientForOrgV1_4(org, channels);
    }
  }
  ...
  async function createChannel(network, keyValueStorePath, channelName, channelConfigPath, orgName = 'org1', networkType = 'fabric-1.0', username) {
    switch (networkType) {
      case 'fabric-1.0':
      default:
